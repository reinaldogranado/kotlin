...
class MultifileClassPartCodegen(
    ...
    private val staticInitClassType = Type.getObjectType(partType.internalName + "__Clinit")
    ...
    override fun generatePropertyAccessorPrefixIfRequired(mv: MethodVisitor) {
        if (requiresDeferredStaticInitialization) {
    ...
    companion object {
        private val OPEN_PART_CLASS_ATTRIBUTES = Opcodes.ACC_SYNTHETIC or Opcodes.ACC_SUPER
