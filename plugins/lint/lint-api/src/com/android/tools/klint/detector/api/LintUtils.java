...
public class LintUtils {
    ...
    /**
     * Convert an {@link ApiVersion} to a {@link
     * AndroidVersion}. The chief problem here is that the {@link
     * ApiVersion}, when using a codename, will not encode the
