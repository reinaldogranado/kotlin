...
public enum Scope {
     ...
     * This will call {@link Detector#run(com.android.tools.klint.detector.api.Context)}} on the detectors unconditionally.
     */
    OTHER;
     ...
     */
    @NonNull
    public static EnumSet<Scope> infer(@NonNull Collection<com.android.tools.klint.detector.api.Project> projects) {
        // Infer the scope
        EnumSet<Scope> scope = EnumSet.noneOf(Scope.class);
        for (com.android.tools.klint.detector.api.Project project : projects) {
