...
public class ReferenceToCompiledKotlinResolveInJavaTestGenerated extends AbstractReferenceToCompiledKotlinResolveInJavaTest {
    ...
    @RunWith(JUnit3RunnerWithInners.class)
    public static class BinaryAndSource extends AbstractReferenceToCompiledKotlinResolveInJavaTest {
    ...
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class SourceOnly extends AbstractReferenceToCompiledKotlinResolveInJavaTest {
