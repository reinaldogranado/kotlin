...
import org.jetbrains.kotlin.idea.caches.resolve.ByJvmSignatureIndexer
...
fun buildDecompiledTextForClassFile(
    ...
    fun buildText(declarations: List<DeclarationDescriptor>) =
            buildDecompiledText(classId.packageFqName, declarations, decompilerRendererForClassFiles, listOf(ByDescriptorIndexer, ByJvmSignatureIndexer))
