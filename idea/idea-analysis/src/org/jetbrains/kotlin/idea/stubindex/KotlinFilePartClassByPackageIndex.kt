...
class KotlinFilePartClassByPackageIndex private constructor() : StringStubIndexExtension<KtFile>() {
    ...
    companion object {
        private val KEY = KotlinIndexUtil.createIndexKey(KotlinFilePartClassByPackageIndex::class.java)

        @JvmField val INSTANCE = KotlinFilePartClassByPackageIndex()
